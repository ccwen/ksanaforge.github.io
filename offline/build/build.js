...
require.register("offline-main/index.js", function(exports, require, module){
/** @jsx React.DOM */
...
require.register("offline-comp1/index.js", function(exports, require, module){
/** @jsx React.DOM */
...
require.register("offline-installdb/index.js", function(exports, require, module){
/** @jsx React.DOM */
var Kde=Require("ksana-document").kde;
...
var filelist= React.createClass({displayName: 'filelist',
  showfile:function(e) {
    return React.DOM.div( {key:e.name}, e[0], " ", React.DOM.button( {onClick:this.deleteFile, 'data-url':e[1]}, "Delete"),
    React.DOM.button( {onClick:this.openFile, 'data-url':e[1]}, "Open")
    )
  },
  openFile:function(e) {
  ...
  render:function() {
    if (!this.props.files || !this.props.files.length) return React.DOM.div( {key:"fl"}, "no files")
    return React.DOM.div( {key:"fl"}, this.props.files.map(this.showfile))
  }
});

var remoteFile=React.createClass({displayName: 'remoteFile',
  getInitialState:function() {
  ...
  addRemoteFile:function(url) {
      ...
      var xhr = new XMLHttpRequest();
      var filename=this.refs.url.getDOMNode().value;
      var that=this;
      ...
      xhr.addEventListener('load', function() {
        ...
        if (slash>-1) fn=fn.substr(slash+1);
  ...
  render:function() {
    if (this.state.downloading)  {
      ...
      React.DOM.input( {ref:"url", defaultValue:"jiangkangyur.kdb"}),
      React.DOM.button( {onClick:this.addRemoteFile}, "add remote")  
      )
    }
  }
});
var installdb = React.createClass({displayName: 'installdb',
  getInitialState: function() {
    return {bar: "world",error:"no error"};
  },
  ...
  initFS:function() {
    var that=this;
    navigator.webkitPersistentStorage.requestQuota(1024*1024*512, 
      function(grantedBytes) {
      that.setState({error:"grantedBytes"+grantedBytes});  
      ...
      that.setState({error:"no byte allow"});  
      console.error( e);
    });
  },
  ...
  render: function() {
    return (
      React.DOM.div(null, 
        React.DOM.input( {onChange:this.addFiles, type:"file", id:"files", multiple:"true", className:"button", accept:".kdb"}),
...
require.register("offline/index.js", function(exports, require, module){
var boot=require("boot");
boot("offline","main","main");
});
...
require.alias("ksanaforge-boot/index.js", "offline/deps/boot/index.js");
require.alias("ksanaforge-boot/index.js", "offline/deps/boot/index.js");
require.alias("ksanaforge-boot/index.js", "boot/index.js");
require.alias("ksanaforge-boot/index.js", "ksanaforge-boot/index.js");
require.alias("ksana-document/index.js", "offline/deps/ksana-document/index.js");
require.alias("ksana-document/document.js", "offline/deps/ksana-document/document.js");
require.alias("ksana-document/api.js", "offline/deps/ksana-document/api.js");
require.alias("ksana-document/xml.js", "offline/deps/ksana-document/xml.js");
require.alias("ksana-document/template_accelon.js", "offline/deps/ksana-document/template_accelon.js");
require.alias("ksana-document/persistent.js", "offline/deps/ksana-document/persistent.js");
require.alias("ksana-document/tokenizers.js", "offline/deps/ksana-document/tokenizers.js");
require.alias("ksana-document/markup.js", "offline/deps/ksana-document/markup.js");
require.alias("ksana-document/typeset.js", "offline/deps/ksana-document/typeset.js");
require.alias("ksana-document/sha1.js", "offline/deps/ksana-document/sha1.js");
require.alias("ksana-document/users.js", "offline/deps/ksana-document/users.js");
require.alias("ksana-document/customfunc.js", "offline/deps/ksana-document/customfunc.js");
require.alias("ksana-document/configs.js", "offline/deps/ksana-document/configs.js");
require.alias("ksana-document/projects.js", "offline/deps/ksana-document/projects.js");
require.alias("ksana-document/indexer.js", "offline/deps/ksana-document/indexer.js");
require.alias("ksana-document/indexer_kd.js", "offline/deps/ksana-document/indexer_kd.js");
require.alias("ksana-document/kdb.js", "offline/deps/ksana-document/kdb.js");
require.alias("ksana-document/kdbfs.js", "offline/deps/ksana-document/kdbfs.js");
require.alias("ksana-document/kdbw.js", "offline/deps/ksana-document/kdbw.js");
require.alias("ksana-document/kdb_sync.js", "offline/deps/ksana-document/kdb_sync.js");
require.alias("ksana-document/kdbfs_sync.js", "offline/deps/ksana-document/kdbfs_sync.js");
require.alias("ksana-document/html5fs.js", "offline/deps/ksana-document/html5fs.js");
require.alias("ksana-document/kse.js", "offline/deps/ksana-document/kse.js");
require.alias("ksana-document/kde.js", "offline/deps/ksana-document/kde.js");
require.alias("ksana-document/boolsearch.js", "offline/deps/ksana-document/boolsearch.js");
require.alias("ksana-document/search.js", "offline/deps/ksana-document/search.js");
require.alias("ksana-document/plist.js", "offline/deps/ksana-document/plist.js");
require.alias("ksana-document/excerpt.js", "offline/deps/ksana-document/excerpt.js");
require.alias("ksana-document/link.js", "offline/deps/ksana-document/link.js");
require.alias("ksana-document/tibetan/wylie.js", "offline/deps/ksana-document/tibetan/wylie.js");
require.alias("ksana-document/languages.js", "offline/deps/ksana-document/languages.js");
require.alias("ksana-document/diff.js", "offline/deps/ksana-document/diff.js");
require.alias("ksana-document/xml4kdb.js", "offline/deps/ksana-document/xml4kdb.js");
require.alias("ksana-document/buildfromxml.js", "offline/deps/ksana-document/buildfromxml.js");
require.alias("ksana-document/tei.js", "offline/deps/ksana-document/tei.js");
require.alias("ksana-document/concordance.js", "offline/deps/ksana-document/concordance.js");
require.alias("ksana-document/regex.js", "offline/deps/ksana-document/regex.js");
require.alias("ksana-document/index.js", "offline/deps/ksana-document/index.js");
require.alias("ksana-document/index.js", "ksana-document/index.js");
require.alias("ksana-document/index.js", "ksana-document/index.js");
require.alias("brighthas-bootstrap/dist/js/bootstrap.js", "offline/deps/bootstrap/dist/js/bootstrap.js");
require.alias("brighthas-bootstrap/dist/js/bootstrap.js", "offline/deps/bootstrap/index.js");
...
require.alias("ksanaforge-kse/index.js", "offline/deps/kse/index.js");
require.alias("ksanaforge-kse/rpc.js", "offline/deps/kse/rpc.js");
require.alias("ksanaforge-kse/rpc_yase.js", "offline/deps/kse/rpc_yase.js");
require.alias("ksanaforge-kse/rpc_document.js", "offline/deps/kse/rpc_document.js");
require.alias("ksanaforge-kse/ksana.js", "offline/deps/kse/ksana.js");
require.alias("ksanaforge-kse/ksana_promise.js", "offline/deps/kse/ksana_promise.js");
require.alias("ksanaforge-kse/index.js", "offline/deps/kse/index.js");
require.alias("ksanaforge-kse/index.js", "kse/index.js");
require.alias("ksanaforge-kse/index.js", "ksanaforge-kse/index.js");
require.alias("offline-main/index.js", "offline/deps/main/index.js");
require.alias("offline-main/index.js", "offline/deps/main/index.js");
require.alias("offline-main/index.js", "main/index.js");
require.alias("offline-main/index.js", "offline-main/index.js");
require.alias("offline-comp1/index.js", "offline/deps/comp1/index.js");
require.alias("offline-comp1/index.js", "offline/deps/comp1/index.js");
require.alias("offline-comp1/index.js", "comp1/index.js");
require.alias("offline-comp1/index.js", "offline-comp1/index.js");
require.alias("offline-installdb/index.js", "offline/deps/installdb/index.js");
require.alias("offline-installdb/index.js", "offline/deps/installdb/index.js");
require.alias("offline-installdb/index.js", "installdb/index.js");
require.alias("offline-installdb/index.js", "offline-installdb/index.js");
require.alias("offline/index.js", "offline/index.js");
if (typeof exports == 'object') {
  module.exports = require('offline');
} else if (typeof define == 'function' && define.amd) {
  define(function(){ return require('offline'); });
} else {
  window['offline'] = require('offline');
}})();