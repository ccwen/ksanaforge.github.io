...
require.register("svgoverlay-main/index.js", function(exports, require, module){
  ...
  render: function() {                     
    return (            
      React.createElement("div", {className: "main"}, 
        ...
        React.createElement(Textview, {texts: this.state.texts})
      )
      );
...
require.register("svgoverlay-comp1/index.js", function(exports, require, module){
/** @jsx React.DOM */
...
require.register("svgoverlay-textview/index.js", function(exports, require, module){
/** @jsx React.DOM */
...
var textview = React.createClass({displayName: 'textview',
  ...
  renderToken:function(token,idx) {
    return React.createElement("span", {key: "T"+idx}, token)
  },
  render: function() {
    return (  
      React.createElement("div", {id: "thetext"}, 
...
require.register("svgoverlay-overlay/index.js", function(exports, require, module){
/** @jsx React.DOM */
...
var overlay = React.createClass({displayName: 'overlay',
  ...
  maskstyle:function() {
    return '<radialGradient id="grad1" cx="50%" cy="50%" r="50%" fx="50%" fy="50%">'+
          '<stop offset="0%" style="stop-color:rgb(0,0,0);stop-opacity:1" />'+
          '<stop offset="100%" style="stop-color:rgb(255,255,255);stop-opacity:0" />'
        '</radialGradient>';
  },
  rect:function() {
    return '<rect x="0" y="0" width="200px" height="200px" fill="#7F007F" opacity="0.5" clip-path="url(#clip1)"/>'
  },
  render: function() {
    return (   
        React.createElement("div", null, 
          React.createElement("div", {id: "svgmarkups"}, 
          React.createElement("svg", {xmlns: "http://www.w3.org/2000/svg", style: {width:"100%",height:"100%"}}, 
           React.createElement("defs", {dangerouslySetInnerHTML: {__html:this.markerstyle()}}
           )
          )
          ), 
          React.createElement("div", {id: "svgmask"}, 
            React.createElement("svg", {xmlns: "http://www.w3.org/2000/svg", style: {width:"100%",height:"100%"}}, 
            React.createElement("defs", {dangerouslySetInnerHTML: {__html:this.maskstyle()}}), 
            React.createElement("g", {id: "masklayer"})
            )
          )
        )
    ); 
...
require.register("svgoverlay-actions/index.js", function(exports, require, module){
var Reflux = Require("reflux");
var actions = Reflux.createActions(["getText","makeLink","makeRandomLink","makeMask"]);

module.exports=actions;
});
require.register("svgoverlay-actions/module1.js", function(exports, require, module){
var module1=[1,2,3,4,5]; 

module.exports=module1;
});
require.register("svgoverlay-stores/index.js", function(exports, require, module){
module.exports=require("./module1");
});
require.register("svgoverlay-stores/module1.js", function(exports, require, module){
var Reflux=Require("reflux");
var actions=Require("actions");
...
var createBound=function(rect) {
    ...
    bounding.setAttribute('fill','blue');
...
var createRandomLink=function(){
    var r1=Math.round(Math.random()*310)
    var r2=Math.round(Math.random()*310);
    if (Math.abs(r2-r1)<5) {
        if (r1>5) r1-=5;
    }
	var n1=$("#thetext").children()[ r1 ];
    var n2=$("#thetext").children()[ r2];
    createLink(n1,n2);
}
var createMask=function(node) {
    var offset=$(node).offset();
    var x=offset.left+$(node).width() /2;
    var y=offset.top+$(node).height() /2;
    var height=$(node).height();

    var outer={left:x-100,top:y-75,width:200,height:150 };
    var inner={left:x-height/2,top:y-height/2,width:height,height:height };

    var svg=$("#svgmask svg g");

    var mask='<path d="M'+outer.left+","+outer.top+"h"+outer.width+"v"+outer.height+
    "h-"+outer.width+"zM"+inner.left+","+inner.top+"v"+inner.height+"h"+inner.width+
    "v-"+inner.width+'z" fill="url(#grad1)" opacity="1" stroke="none"/>';
    var html=svg.html();
    svg.html(html+mask);
}
var createLink=function(n1,n2) {
	...
	var fromx=from.left , fromy=from.top;
	var tox=to.left, toy=to.top;

    if (tox>fromx) fromx+=w; else tox+=w;
    if (toy>fromy) fromy+=h; else toy+=h;
	var midx=fromx;
	var midy=toy;
...
require.register("svgoverlay-controls/index.js", function(exports, require, module){
/** @jsx React.DOM */
...
var controls = React.createClass({displayName: 'controls',
  ...
  makemask:function() {
    var i=Math.round(Math.random()*320);
    var node=$("#thetext").children()[i];
    actions.makeMask(node);
  },
  render: function() {
    return (
      React.createElement("div", null, 
        React.createElement("button", {onClick: this.makelink}, "make link"), 
        React.createElement("button", {onClick: this.makemask}, "mask")
      )
    );
  }
});
...
require.register("svgoverlay/index.js", function(exports, require, module){
var boot=require("boot");
boot("svgoverlay","main","main");
});
...
require.alias("ksanaforge-boot/index.js", "svgoverlay/deps/boot/index.js");
require.alias("ksanaforge-boot/ksanagap.js", "svgoverlay/deps/boot/ksanagap.js");
require.alias("ksanaforge-boot/downloader.js", "svgoverlay/deps/boot/downloader.js");
require.alias("ksanaforge-boot/kfs.js", "svgoverlay/deps/boot/kfs.js");
require.alias("ksanaforge-boot/kfs_html5.js", "svgoverlay/deps/boot/kfs_html5.js");
require.alias("ksanaforge-boot/mkdirp.js", "svgoverlay/deps/boot/mkdirp.js");
require.alias("ksanaforge-boot/index.js", "svgoverlay/deps/boot/index.js");
require.alias("ksanaforge-boot/index.js", "boot/index.js");
require.alias("ksanaforge-boot/index.js", "ksanaforge-boot/index.js");
require.alias("brighthas-bootstrap/dist/js/bootstrap.js", "svgoverlay/deps/bootstrap/dist/js/bootstrap.js");
require.alias("brighthas-bootstrap/dist/js/bootstrap.js", "svgoverlay/deps/bootstrap/index.js");
...
require.alias("ksana-document/index.js", "svgoverlay/deps/ksana-document/index.js");
require.alias("ksana-document/document.js", "svgoverlay/deps/ksana-document/document.js");
require.alias("ksana-document/api.js", "svgoverlay/deps/ksana-document/api.js");
require.alias("ksana-document/xml.js", "svgoverlay/deps/ksana-document/xml.js");
require.alias("ksana-document/template_accelon.js", "svgoverlay/deps/ksana-document/template_accelon.js");
require.alias("ksana-document/persistent.js", "svgoverlay/deps/ksana-document/persistent.js");
require.alias("ksana-document/tokenizers.js", "svgoverlay/deps/ksana-document/tokenizers.js");
require.alias("ksana-document/markup.js", "svgoverlay/deps/ksana-document/markup.js");
require.alias("ksana-document/typeset.js", "svgoverlay/deps/ksana-document/typeset.js");
require.alias("ksana-document/sha1.js", "svgoverlay/deps/ksana-document/sha1.js");
require.alias("ksana-document/users.js", "svgoverlay/deps/ksana-document/users.js");
require.alias("ksana-document/customfunc.js", "svgoverlay/deps/ksana-document/customfunc.js");
require.alias("ksana-document/configs.js", "svgoverlay/deps/ksana-document/configs.js");
require.alias("ksana-document/projects.js", "svgoverlay/deps/ksana-document/projects.js");
require.alias("ksana-document/indexer.js", "svgoverlay/deps/ksana-document/indexer.js");
require.alias("ksana-document/indexer_kd.js", "svgoverlay/deps/ksana-document/indexer_kd.js");
require.alias("ksana-document/kdb.js", "svgoverlay/deps/ksana-document/kdb.js");
require.alias("ksana-document/kdbfs.js", "svgoverlay/deps/ksana-document/kdbfs.js");
require.alias("ksana-document/kdbw.js", "svgoverlay/deps/ksana-document/kdbw.js");
require.alias("ksana-document/kdb_sync.js", "svgoverlay/deps/ksana-document/kdb_sync.js");
require.alias("ksana-document/kdbfs_sync.js", "svgoverlay/deps/ksana-document/kdbfs_sync.js");
require.alias("ksana-document/html5fs.js", "svgoverlay/deps/ksana-document/html5fs.js");
require.alias("ksana-document/kdbfs_android.js", "svgoverlay/deps/ksana-document/kdbfs_android.js");
require.alias("ksana-document/kdbfs_ios.js", "svgoverlay/deps/ksana-document/kdbfs_ios.js");
require.alias("ksana-document/kse.js", "svgoverlay/deps/ksana-document/kse.js");
require.alias("ksana-document/kde.js", "svgoverlay/deps/ksana-document/kde.js");
require.alias("ksana-document/boolsearch.js", "svgoverlay/deps/ksana-document/boolsearch.js");
require.alias("ksana-document/search.js", "svgoverlay/deps/ksana-document/search.js");
require.alias("ksana-document/plist.js", "svgoverlay/deps/ksana-document/plist.js");
require.alias("ksana-document/excerpt.js", "svgoverlay/deps/ksana-document/excerpt.js");
require.alias("ksana-document/link.js", "svgoverlay/deps/ksana-document/link.js");
require.alias("ksana-document/tibetan/wylie.js", "svgoverlay/deps/ksana-document/tibetan/wylie.js");
require.alias("ksana-document/languages.js", "svgoverlay/deps/ksana-document/languages.js");
require.alias("ksana-document/diff.js", "svgoverlay/deps/ksana-document/diff.js");
require.alias("ksana-document/xml4kdb.js", "svgoverlay/deps/ksana-document/xml4kdb.js");
require.alias("ksana-document/buildfromxml.js", "svgoverlay/deps/ksana-document/buildfromxml.js");
require.alias("ksana-document/tei.js", "svgoverlay/deps/ksana-document/tei.js");
require.alias("ksana-document/concordance.js", "svgoverlay/deps/ksana-document/concordance.js");
require.alias("ksana-document/regex.js", "svgoverlay/deps/ksana-document/regex.js");
require.alias("ksana-document/bsearch.js", "svgoverlay/deps/ksana-document/bsearch.js");
require.alias("ksana-document/persistentmarkup_pouchdb.js", "svgoverlay/deps/ksana-document/persistentmarkup_pouchdb.js");
require.alias("ksana-document/underlines.js", "svgoverlay/deps/ksana-document/underlines.js");
require.alias("ksana-document/index.js", "svgoverlay/deps/ksana-document/index.js");
require.alias("ksana-document/index.js", "ksana-document/index.js");
require.alias("ksana-document/index.js", "ksana-document/index.js");
require.alias("ksanaforge-fileinstaller/index.js", "svgoverlay/deps/fileinstaller/index.js");
require.alias("ksanaforge-fileinstaller/index.js", "svgoverlay/deps/fileinstaller/index.js");
...
require.alias("ksanaforge-checkbrowser/index.js", "svgoverlay/deps/checkbrowser/index.js");
require.alias("ksanaforge-checkbrowser/index.js", "svgoverlay/deps/checkbrowser/index.js");
require.alias("ksanaforge-checkbrowser/index.js", "checkbrowser/index.js");
require.alias("ksanaforge-checkbrowser/index.js", "ksanaforge-checkbrowser/index.js");
require.alias("ksanaforge-htmlfs/index.js", "svgoverlay/deps/htmlfs/index.js");
require.alias("ksanaforge-htmlfs/index.js", "svgoverlay/deps/htmlfs/index.js");
require.alias("ksanaforge-htmlfs/index.js", "htmlfs/index.js");
require.alias("ksanaforge-htmlfs/index.js", "ksanaforge-htmlfs/index.js");
require.alias("spoike-reflux/reflux.js", "svgoverlay/deps/reflux/reflux.js");
require.alias("spoike-reflux/reflux.js", "svgoverlay/deps/reflux/index.js");
require.alias("spoike-reflux/reflux.js", "reflux/index.js");
require.alias("spoike-reflux/reflux.js", "spoike-reflux/index.js");
require.alias("svgoverlay-main/index.js", "svgoverlay/deps/main/index.js");
require.alias("svgoverlay-main/index.js", "svgoverlay/deps/main/index.js");
require.alias("svgoverlay-main/index.js", "main/index.js");
require.alias("svgoverlay-main/index.js", "svgoverlay-main/index.js");
require.alias("svgoverlay-comp1/index.js", "svgoverlay/deps/comp1/index.js");
require.alias("svgoverlay-comp1/index.js", "svgoverlay/deps/comp1/index.js");
require.alias("svgoverlay-comp1/index.js", "comp1/index.js");
require.alias("svgoverlay-comp1/index.js", "svgoverlay-comp1/index.js");
require.alias("svgoverlay-textview/index.js", "svgoverlay/deps/textview/index.js");
require.alias("svgoverlay-textview/index.js", "svgoverlay/deps/textview/index.js");
require.alias("svgoverlay-textview/index.js", "textview/index.js");
require.alias("svgoverlay-textview/index.js", "svgoverlay-textview/index.js");
require.alias("svgoverlay-overlay/index.js", "svgoverlay/deps/overlay/index.js");
require.alias("svgoverlay-overlay/index.js", "svgoverlay/deps/overlay/index.js");
require.alias("svgoverlay-overlay/index.js", "overlay/index.js");
require.alias("svgoverlay-overlay/index.js", "svgoverlay-overlay/index.js");
require.alias("svgoverlay-actions/index.js", "svgoverlay/deps/actions/index.js");
require.alias("svgoverlay-actions/module1.js", "svgoverlay/deps/actions/module1.js");
require.alias("svgoverlay-actions/index.js", "svgoverlay/deps/actions/index.js");
require.alias("svgoverlay-actions/index.js", "actions/index.js");
require.alias("svgoverlay-actions/index.js", "svgoverlay-actions/index.js");
require.alias("svgoverlay-stores/index.js", "svgoverlay/deps/stores/index.js");
require.alias("svgoverlay-stores/module1.js", "svgoverlay/deps/stores/module1.js");
require.alias("svgoverlay-stores/index.js", "svgoverlay/deps/stores/index.js");
require.alias("svgoverlay-stores/index.js", "stores/index.js");
require.alias("svgoverlay-stores/index.js", "svgoverlay-stores/index.js");
require.alias("svgoverlay-controls/index.js", "svgoverlay/deps/controls/index.js");
require.alias("svgoverlay-controls/index.js", "svgoverlay/deps/controls/index.js");
require.alias("svgoverlay-controls/index.js", "controls/index.js");
require.alias("svgoverlay-controls/index.js", "svgoverlay-controls/index.js");
require.alias("svgoverlay/index.js", "svgoverlay/index.js");
if (typeof exports == 'object') {
  module.exports = require('svgoverlay');
} else if (typeof define == 'function' && define.amd) {
  define(function(){ return require('svgoverlay'); });
} else {
  window['svgoverlay'] = require('svgoverlay');
}})();